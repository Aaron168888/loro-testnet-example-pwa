...
services:
  registry:
    rpcEndpoint: '${CERC_REGISTRY_REST_ENDPOINT:-https://weapp-laconic-testnet.stakingcabin.com/}'
    gqlEndpoint: '${CERC_REGISTRY_GQL_ENDPOINT:-https://weapp-laconic-testnet.stakingcabin.com/api}'
